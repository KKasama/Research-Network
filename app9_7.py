...
st.set_page_config(page_title="Research Network v9.7", page_icon="🔬", layout="wide")
...
with st.sidebar:
    ...
    st.title("🔬 Research Network v9.7")
    st.markdown("---")
...
**Note**: Requires OpenAlex data (not available for PubMed or Lens.org sources)."""),
    ...
    if vos_data:
        ...
        # ── Bibliometrix 分析（Python内完結）──
        elif tl("Bibliometrix", "Bibliometrix") in viz_method:
